...
// uint8_t  binarySearch(uint8_t l, uint8_t r, uint8_t x, uint8_t cnt) {
//   volatile uint8_t mid = l + (r - l) / 2;
//   uint8_t temp=-1;
//   if (r >= l && cnt<8) {
//     // If the element is present at the middle itself
//     if (arr[mid] == x) {
//       binarySearch(pre_l, pre_r, x,cnt+1);
//       temp = mid;
//       arr[mid] = x;
//     }
//     else if (arr[mid] > x) {
//       temp = binarySearch(l, mid - 1, x,cnt+1);
//     }
//     else {
//       temp = binarySearch(mid + 1, r, x,cnt+1);
//     }
//   }
...
// solution for avoiding if else branching leakage
